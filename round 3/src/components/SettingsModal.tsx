...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 font-mono select-none animate-fade-in">
      <div className="w-full max-w-xl bg-[#0c0d12] border-2 border-red-900/80 rounded-lg p-6 shadow-[0_0_50px_rgba(229,9,20,0.3)] text-gray-200 tactical-frame tactical-corners relative">
